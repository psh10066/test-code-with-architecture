...
class CertificationServiceTest {
    ...
    @Test
    void 이메일과_컨텐츠가_제대로_만들어져서_보내는지_테스트한다() {
        // given
        FakeMailSender fakeMailSender = new FakeMailSender();
        CertificationService certificationService = new CertificationService(fakeMailSender);

        // when
        certificationService.send("psh10066@naver.com", 1, "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");

        // then
        assertThat(fakeMailSender.email).isEqualTo("psh10066@naver.com");
